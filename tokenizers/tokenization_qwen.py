# Copyright (c) Alibaba Cloud.  # noqa: CPY001
#
# This source code is licensed under the license found in the
# LICENSE file in the root directory of this source tree.
"""Define QWen Tokenizer Class."""
...
SPECIAL_TOKENS = tuple(
    enumerate(
        ((ENDOFTEXT, IMSTART, IMEND, *EXTRAS)),
...
class QWenTokenizer(PreTrainedTokenizer):
    ...
    Attributes:
        ...
        extra_vocab_file (str, optional): Path to an extra vocabulary file.
        mergeable_ranks (Dict[bytes, int]): The mergeable ranks for byte pair encoding.
        special_tokens (Dict[str, int]): The special tokens.
        decoder (Dict[int, Union[bytes, str]]): The decoder for token IDs.
        tokenizer (tiktoken.Encoding): The tokenizer encoding.
        eod_id (int): The end of document token ID.
        im_start_id (int): The start of inline message token ID.
        im_end_id (int): The end of inline message token ID.

    Methods:
        __init__: Initializes the QWenTokenizer.
        __getstate__: Gets the state for pickling.
        __setstate__: Sets the state for unpickling.
        ...
        save_vocabulary: Saves the vocabulary to a directory.
        ...
        _convert_id_to_token: Converts an ID to a token.
        _convert_token_to_id: Converts a token to an ID.
        _tokenize: Converts a string to a sequence of tokens.
    ...
    def __init__(
        ...
        **kwargs,
        ...
        """Initializes the QWenTokenizer.

        Args:
            vocab_file (str): Path to the vocabulary file.
            errors (str, optional): How to handle errors in decoding UTF-8 byte sequences. Defaults to 'replace'.
            extra_vocab_file (str, optional): Path to an extra vocabulary file. Defaults to None.
