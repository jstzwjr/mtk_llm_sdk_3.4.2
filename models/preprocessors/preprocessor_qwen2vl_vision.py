# Copyright 2024 The Qwen team, Alibaba Group and the HuggingFace Inc. team. All rights reserved.  # noqa: CPY001
#
...
"""Qwen2VL Vision preprocessor class."""
    ...
    def preprocess(
        ...
        **kwargs: Other kwargs.
        ...
        if images is not None:
            ...
            data = {'input_features': pixel_values, 'image_grid_thw': vision_grid_thws}
        ...
        if videos is not None:
            ...
            pixel_values = np.array(pixel_values)
            vision_grid_thws = np.array(vision_grid_thws)
            data = {'input_features': pixel_values, 'video_grid_thw': vision_grid_thws}

        kwargs.update(
            {
                'image_grid_thw': vision_grid_thws,
                'video_grid_thw': vision_grid_thws,
                'qwen2vl_img_seq_length': pixel_values.shape[0],
