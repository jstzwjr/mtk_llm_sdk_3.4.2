...
# the License.
# ==================================================================================================
"""Configuration of Qwen2AudioEncoder."""

from ...utils import logger
from ..configuration_base import BaseAudioEncoderConfig


class Qwen2AudioEncoderConfig(BaseAudioEncoderConfig):
    """Configuration class for the Qwen2AudioEncoder model.

    This class inherits from CommonConfig and is used to set up the configuration
    for the Qwen2AudioEncoder model, including handling response, model type, and specific
    parameters related to attention mechanisms and embeddings.

    Attributes:
        model_type (str): The type of the model, expected to be 'qwen2_audio_encoder'.
    ...
    def __init__(self, **kwargs):
        ...
        if self.model_type != 'qwen2_audio_encoder':
            logger.error(f'Expected model_type to be qwen2_audio_encoder but got {self.model_type} instead')
    ...
    def print_config(self):
        ...
        logger.info(f'Audio Text:              {self.audio_text}')
