...
# ==============================================================================
"""Define Qwen2-VL vision projector (Patch Merger) class."""
...
class PatchMergerProjector(BaseProjector):
    """Patch Merger Vision Projector class.

    This class implements the vision projector using Patch Merger from Qwen2-VL.
    """
    ...
    def _generate_default_state_dict_mapping(self):
        ...
        self.state_dict_mapping = {
            'ln_q_bias': {'ln_q.bias': 'visual.merger.ln_q.bias'},
    ...
    def forward(self, x):
        ...
        """
        return self.projector(self.ln_q(x).view(-1, self.hidden_size))
