# Copyright (C) 2020 The HuggingFace Evaluate Authors.  # noqa: CPY001
#
...
Args:
    ...
    tokenizer : approach used for tokenizing `predictions` and `references`.
        ...
        used by WMT. This can be replaced by any function that takes a string as input and returns a
        list of tokens as output.
...
class Bleu(evaluate.Metric):
    ...
    def _compute(self, predictions, references, tokenizer=Tokenizer13a(), max_order=4, smooth=False):  # noqa: B008
